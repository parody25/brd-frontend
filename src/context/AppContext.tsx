...
const appReducer = (state: AppState, action: AppAction): AppState => {
  switch (action.type) {
    ...
    case 'REMOVE_DOCUMENT': return { ...state, documents: state.documents.filter(doc => doc.id !== action.payload) };
...
interface AppContextType { state: AppState; dispatch: React.Dispatch<AppAction>; }
